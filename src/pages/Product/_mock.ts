...
for (let i = 0; i < 8; i += 1) {
  tableListDataSource.push({
    ...
    name: `W967D6HBGX7I ${i}`,
    title: `W967D6HBGX7I ${i}`,
    owner: 'Winbond',
    desc: 'Open source IoT platform with multiple modules...',
    ...
    content: 'NuMaker Brick Board',
    supportedDevices: 'M451, M452LG6AE',
    platform: '',
    application: 'IoT',
  });
}
