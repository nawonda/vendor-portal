...
class UpdateForm extends Component<UpdateFormProps, UpdateFormState> {
  ...
  renderContent = (currentStep: number, formVals: FormValsType) => {
    ...
    return [
      <FormItem key="name" {...this.formLayout} label="Part Number">
      ...
      <FormItem key="desc" {...this.formLayout} label="Description">
        {form.getFieldDecorator('desc', {
          rules: [{ required: true, message: 'At least 5 Characters！', min: 5 }],
          initialValue: formVals.desc,
        })(<TextArea rows={4} placeholder="At least 5 Characters" />)}
      </FormItem>,
    ];
  };
